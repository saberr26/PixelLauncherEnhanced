...
object Constants {
    ...
    const val THEMED_ICON_FG_LIGHT_USE_MONET = "themed_icon_fg_light_use_monet"
    const val THEMED_ICON_FG_LIGHT_MONET_ROLE = "themed_icon_fg_light_monet_role"
    const val THEMED_ICON_BG_LIGHT_USE_MONET = "themed_icon_bg_light_use_monet"
    const val THEMED_ICON_BG_LIGHT_MONET_ROLE = "themed_icon_bg_light_monet_role"
    const val THEMED_ICON_FG_DARK_USE_MONET = "themed_icon_fg_dark_use_monet"
    const val THEMED_ICON_FG_DARK_MONET_ROLE = "themed_icon_fg_dark_monet_role"
    const val THEMED_ICON_BG_DARK_USE_MONET = "themed_icon_bg_dark_use_monet"
    const val THEMED_ICON_BG_DARK_MONET_ROLE = "themed_icon_bg_dark_monet_role"
    const val FOLDER_LIGHT_USE_MONET = "folder_light_use_monet"
    const val FOLDER_LIGHT_MONET_ROLE = "folder_light_monet_role"
    const val FOLDER_DARK_USE_MONET = "folder_dark_use_monet"
    const val FOLDER_DARK_MONET_ROLE = "folder_dark_monet_role"
